...
load_ddh_data(app_data_dir, #defined in setup
              object_name = c("master_top_table","master_bottom_table", "hmdb_proteins", "hmdb_metabolites")
) 
...
make_bipartite_graph(toptable_data = master_top_table,
                     bottomtable_data = master_bottom_table,
                     protein_data = hmdb_proteins,
                     metabolite_data = hmdb_metabolites,
                     ...
                     collapsed = TRUE,
                     threshold = 10,
                     corrType = "Positive")  #params$type, content = params$content))
